...
public class BookingPane extends BasicPane {
	...
	private void fillNameList() {
		...
		String[] a = { "Dokumentär om Borrby", ("Rädda valarna"), ("Vi räddade valarna"), ("Valarna har nu tagit över"),
				("Hoppla pålle"), ("HOPPLA SNABBARE HÄSTJÄVEL"), "Folk spenderar för mycket tid på youtube" };
		ArrayList<String> movies = new ArrayList<String>(Arrays.asList(a));
		// Use DB method
		for (String m : movies)
